  ...
  return (
    <div className="bg-white p-8 rounded-2xl shadow-lg max-w-3xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-2xl font-bold text-gray-900">🧾 Redemption History</h3>
      ...
      {isLoading ? (
        ...
        <p className="text-gray-500 text-lg text-center py-8">No redemption history found with applied filters.</p>
      ) : (
        <div className="max-h-[400px] overflow-y-auto pr-2">
          <ul className="space-y-4">
            {history.map((item) => {
              ...
              return (
                <li key={item.id} className="bg-gray-50 p-5 rounded-xl shadow-sm border border-gray-200">
                  <div className="flex justify-between items-center mb-2">
                    <h4 className="font-semibold capitalize text-xl text-gray-900 flex items-center gap-2">
