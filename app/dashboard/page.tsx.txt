          ...
          <>
            ...
            <section className="bg-gradient-to-br from-primary-light to-primary-lighter p-8 rounded-2xl shadow-xl text-white">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {/* Wallet Balance */}
                <Card className="bg-card-background/20 backdrop-blur-sm p-5 rounded-xl shadow-lg flex flex-col items-center justify-center text-center text-white">
                  <CardTitle className="text-4xl font-bold mb-2 drop-shadow-sm">
                    {isLoadingStats ? "..." : `${dashboardStats?.points_balance || 0} pts`}
                  </CardTitle>
                  <CardContent className="p-0 text-white/90">Wallet Balance</CardContent>
                </Card>
                ...
                <Card className="bg-card-background/20 backdrop-blur-sm p-5 rounded-xl shadow-lg flex flex-col items-center justify-center text-center text-white">
                  ...
                  <CardContent className="p-0 text-white/90">Surveys Completed</CardContent>
                </Card>
                ...
                <Card className="bg-card-background/20 backdrop-blur-sm p-5 rounded-xl shadow-lg flex flex-col items-center justify-center text-center text-white">
                  ...
                  <CardContent className="p-0 text-white/90">Pending Redemptions</CardContent>
                </Card>
                ...
                <Card className="bg-card-background/20 backdrop-blur-sm p-5 rounded-xl shadow-lg flex flex-col items-center justify-center text-center text-white">
                  ...
                  <CardContent className="p-0 text-white/90">Total Earned</CardContent>
                </Card>
              </div>
            </section>
