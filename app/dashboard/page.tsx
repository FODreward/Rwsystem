      ...
      case "dashboardHome":
        return (
          <>
            ...
            <section className="bg-gradient-to-br from-primary-light to-primary-lighter p-6 rounded-2xl shadow-xl text-white">
              <h2 className="text-3xl font-extrabold mb-6 drop-shadow-md">Welcome Back, Survey Enthusiast!</h2>
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {" "}
                {/* Changed grid to 2 columns on mobile, 4 on larger */}
                {/* Wallet Balance */}
                <Card className="bg-card-background/20 backdrop-blur-sm p-4 rounded-xl shadow-lg flex flex-col items-center justify-center text-center text-white">
                  {" "}
                  {/* Reduced padding */}
                  <CardTitle className="text-3xl font-bold mb-1 drop-shadow-sm">
                    {" "}
                    {/* Reduced font size */}
                    {isLoadingStats ? "..." : `${dashboardStats?.points_balance || 0} pts`}
                  </CardTitle>
                  <CardContent className="p-0 text-sm text-white/90">Wallet Balance</CardContent>{" "}
                  {/* Reduced font size */}
                </Card>
                {/* Completed Surveys */}
                <Card className="bg-card-background/20 backdrop-blur-sm p-4 rounded-xl shadow-lg flex flex-col items-center justify-center text-center text-white">
                  ...
                  <CardContent className="p-0 text-sm text-white/90">Surveys Completed</CardContent>
                </Card>
                {/* Pending Redemptions */}
                <Card className="bg-card-background/20 backdrop-blur-sm p-4 rounded-xl shadow-lg flex flex-col items-center justify-center text-center text-white">
                  <CardTitle className="text-3xl font-bold mb-1 drop-shadow-sm">
                  ...
                  <CardContent className="p-0 text-sm text-white/90">Pending Redemptions</CardContent>
                </Card>
                {/* Total Earned */}
                <Card className="bg-card-background/20 backdrop-blur-sm p-4 rounded-xl shadow-lg flex flex-col items-center justify-center text-center text-white">
                  <CardTitle className="text-3xl font-bold mb-1 drop-shadow-sm">
                  ...
                  <CardContent className="p-0 text-sm text-white/90">Total Earned</CardContent>
                </Card>
              </div>
            </section>
