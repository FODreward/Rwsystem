          ...
          <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white px-4 py-3 flex items-center justify-between border-b border-gray-100">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-gray-900">{getUserDisplayName(currentUser?.name)} O.</span>
                </div>
              </div>
            </div>
            ...
            {sidebarOpen && (
              <div className="fixed inset-0 bg-black bg-opacity-50 z-50" onClick={toggleSidebar}>
                <div className="bg-gray-50 w-80 h-full shadow-2xl" onClick={(e) => e.stopPropagation()}>
                  ...
                  {/* Navigation with modern card-based design */}
                  <nav className="p-4 space-y-2">
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="font-medium text-gray-900">Available Surveys</span>
                      </div>
                    </button>
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="font-medium text-gray-900">Transfer Points</span>
                      </div>
                    </button>
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="font-medium text-gray-900">Transfer History</span>
                      </div>
                    </button>
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="font-medium text-gray-900">Redemption History</span>
                      </div>
                    </button>
                    ...
                    <div className="pt-2 border-t border-gray-200 mt-4">
                      <button
                        ...
                        className="w-full bg-red-50 rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-200 border border-red-100 hover:bg-red-100"
                      >
                        <div className="flex items-center space-x-3">
