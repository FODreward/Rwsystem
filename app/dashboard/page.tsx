...
export default function SurveySparkPro() {
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="font-semibold text-gray-900">
                    {activityData?.[0] ? formatTimeAgo(new Date(activityData[0].created_at)) : "Recently"}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-br from-indigo-500 to-blue-600 p-6 rounded-2xl text-white shadow-lg">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold">{dashboardStats.points_balance}</p>
                  </div>
              ...
              <div className="bg-gradient-to-br from-green-500 to-emerald-600 p-6 rounded-2xl text-white shadow-lg">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold">{dashboardStats.pending_points_balance}</p>
                  </div>
                  <div className="bg-white bg-opacity-20 p-3 rounded-xl">
              ...
              <div className="bg-gradient-to-br from-purple-500 to-pink-600 p-6 rounded-2xl text-white shadow-lg">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold">{dashboardStats.completed_surveys}</p>
                  </div>
                  <div className="bg-white bg-opacity-20 p-3 rounded-xl">
              ...
              <div className="bg-gradient-to-br from-orange-500 to-red-600 p-6 rounded-2xl text-white shadow-lg">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold">{dashboardStats.pending_redemptions}</p>
                  </div>
                  <div className="bg-white bg-opacity-20 p-3 rounded-xl">
              ...
              <div className="bg-gradient-to-br from-teal-500 to-cyan-600 p-6 rounded-2xl text-white shadow-lg">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold">{dashboardStats.total_earned}</p>
                  </div>
                  <div className="bg-white bg-opacity-20 p-3 rounded-xl">
                  ...
                  {activityData?.slice(0, 5).map((activity) => (
                    <div key={activity.id} className="flex items-start space-x-3">
                      <div className="flex-shrink-0 w-8 h-8 bg-green-100 text-green-600 rounded-full flex items-center justify-center">
                        {emojiMap[activity.description.split(" ")[0]] ? (
                          <span>{emojiMap[activity.description.split(" ")[0]]}</span>
                        ) : (
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-500 text-sm">{formatTimeAgo(new Date(activity.created_at))}</p>
                      </div>
                    </div>
                  )) || []}
                </div>
  ...
  // Error state
  if (statsError || !dashboardStats || activityError || !activityData) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <div className="text-right">
                  ...
                  <p className="text-xs text-gray-600">{dashboardStats.points_balance} points</p>
                </div>
