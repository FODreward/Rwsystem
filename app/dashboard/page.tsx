...
import AvailableSurveysSection from "@/components/AvailableSurveysSection"
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <h3 className="text-xl font-bold">Premium Offers & Tasks Available!</h3>
                    </div>
                    <p className="text-purple-100 mb-4">
                      High-value opportunities including surveys, offers, and tasks
                    </p>
                    <div className="flex items-center space-x-1 text-purple-100">
                      <ChevronRight className="h-4 w-4" />
                      <span className="text-sm">Click to explore available opportunities</span>
                    </div>
                  </div>
                    ...
                    <nav className="p-3 space-y-1 pb-3">
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="font-medium text-gray-900 text-sm">Available Offers</span>
                        </div>
                      </button>
