...
import { Mail, Phone, MapPin, Clock, MessageSquare, Headphones, HelpCircle, Zap, Shield } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-20">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <img
              src="/team.png"
              alt="Our Customer Support Team - Ready to help you succeed"
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:info@survecta.com?subject=Support Request&body=Hello Survecta Support Team,%0D%0A%0D%0AI need assistance with:%0D%0A%0D%0A"
                      className="text-white/90 text-lg hover:text-white transition-colors underline"
                    >
                      info@survecta.com
                    </a>
