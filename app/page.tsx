  ...
  return (
    <>
      ...
      <header className="bg-white shadow-sm py-4">
        ...
        <div id="mobileMenu" className="hidden md:hidden bg-white py-2 px-4 border-t border-gray-200">
          <ul className="flex flex-col space-y-2">
            <li>
              <Link href="#features" className="block py-2 text-gray-600 hover:text-primary-600 transition-colors">
                Features
              </Link>
            </li>
            <li>
              <Link href="#how-it-works" className="block py-2 text-gray-600 hover:text-primary-600 transition-colors">
                How It Works
              </Link>
            </li>
            <li>
              <Link href="#testimonials" className="block py-2 text-gray-600 hover:text-primary-600 transition-colors">
                Testimonials
              </Link>
            </li>
            <li>
              <Link href="#contact" className="block py-2 text-gray-600 hover:text-primary-600 transition-colors">
                Contact
              </Link>
            </li>
          </ul>
