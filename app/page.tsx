          ...
          {isMenuOpen && (
            ...
            >
              <div className="container mx-auto px-4 space-y-4">
                <Link href="#features" className="block text-gray-600 hover:text-purple-600 transition-colors py-2">
                  Features
                </Link>
                <Link href="#how-it-works" className="block text-gray-600 hover:text-purple-600 transition-colors py-2">
                  How It Works
                </Link>
                <Link href="#contact" className="block text-gray-600 hover:text-purple-600 transition-colors py-2">
                  Contact
                </Link>
                <Link href="/about-us" className="block text-gray-600 hover:text-purple-600 transition-colors py-2">
                  About
                </Link>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Survecta. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
